...
public class Constants {
    ...
    public static final String GREETING_SUBJECT = "Welcome to Get Service!";

    public static final String HI_MSG = "Hi there, ";
    public static final String GREETING_MSG = "\n" +
            "Thanks for joining \"Get Service\", and welcome! \n" +
            "At get Service, we believe in professionally and providing top-of-the-line workers for our customer. \n" +
            "\n" +
